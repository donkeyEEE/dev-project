...
- **[implement](./implement/SKILL.md)**: Build the work described by a spec or set of tickets, driving `$dev-engineering:tdd` at pre-agreed seams and closing out with `$dev-engineering:code-review` before committing.
...
- **[domain-modeling](./domain-modeling/SKILL.md)**: Actively build and sharpen a project's domain model while discussing terminology or editing `CONTEXT.md` and ADRs.
