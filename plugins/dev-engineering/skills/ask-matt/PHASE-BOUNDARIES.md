...
| **`$dev-productivity:handoff`** | Write a portable markdown file and seed a session anywhere with it. |
...
**3. Do you need to hand off?** `$dev-productivity:handoff` is narrow. You need it only when you are:
...
That list is the whole clause. What `$dev-productivity:handoff` buys is **portability**: a file that travels. If nothing is travelling, you don't need it.
...
| Secondary (`/compact`, `$dev-productivity:handoff`) | Lossy       | Less  | Lots         |
